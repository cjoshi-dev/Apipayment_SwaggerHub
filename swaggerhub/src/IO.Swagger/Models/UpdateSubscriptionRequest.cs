...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateSubscriptionRequest : IEquatable<UpdateSubscriptionRequest>
    { 
        /// <summary>
        /// Gets or Sets Items
        /// </summary>
        ...
        [DataMember(Name="proration_behavior")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((UpdateSubscriptionRequest)obj);
        }

        /// <summary>
        /// Returns true if UpdateSubscriptionRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateSubscriptionRequest to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ProrationBehavior.GetHashCode();
                return hashCode;
            }
        }
